...
describe("MakrovMachine Class Tests", function () {
	...
	describe("Test Suite for markov machine's intitializing this.words' split", function () {
		beforeAll(function () {
			console.log("BEFORE ALL this.words TEST!");
		});
	...
	describe("Test Suite for markov machine's this.makeChains succesfully builds this.wordMapChains", function () {
		beforeAll(function () {
			console.log("BEFORE ALL this.makeChains() TESTS!");
		});
	...
	describe("Test Suite for markov machine's makeText() function sucessfully creates text as expected", function () {
		beforeAll(function () {
			console.log("BEFORE ALL this.makeText() TESTS!");
		});

		test("Test for this.makeText() to return expected string with 0 words", function () {
			// Test Logic
			let input = testString.slice(0, testString.length);
			// console.log("Test String:",input);
			let mm = new MarkovMachine(input);
		...
		test("Test for this.makeText() to return expected string with 1 word", function () {
			// Test Logic
			let input = testString.slice(0, testString.length);
			// console.log("Test String:",input);
			let mm = new MarkovMachine(input);
		...
		test("Test for this.makeText() to return expected string with 2 words", function () {
			// Test Logic
			let input = testString.slice(0, testString.length);
			// console.log("Test String:",input);
			let mm = new MarkovMachine(input);
		...
		test("Test for this.makeText() to return expected string with 100 words by default", function () {
			// Test Logic
			let input = testString.slice(0, testString.length);
			// console.log("Test String:",input);
			let mm = new MarkovMachine(input);
